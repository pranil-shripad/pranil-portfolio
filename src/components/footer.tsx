      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            {footerSocials.map((social) => (
              <a
                ...
                className="p-2 rounded-lg text-muted-foreground hover:text-violet-accent hover:bg-violet-soft/50 transition-all duration-300"
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-1">
            Built with <Heart className="size-3 text-violet-accent fill-violet-accent" /> by Pranil
          </p>
        </div>
      </div>
    </footer>
